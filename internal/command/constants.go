...
var AllowedInputFormats = []string{FormatEnv, FormatJson, FormatJsonL, FormatBatch}
var AllowedDumpFormats = []string{FormatEnv, FormatJson, FormatJsonCompact}

const ExampleEnv = `# This is an example environment variable configuration file.
...
// ExampleJsonL is an example JSONL configuration file.
const ExampleJsonL = `{"output": "output_jsonl_1.txt","template": "./templates/custom.tpl","variables":{"GREET": "Hi from JSONL #1!"}}
{"output": "output_jsonl_2.txt","template": "./templates/custom.tpl","variables":{"GREET": "Hi from JSONL #2!"}}
`
...
const ExampleTemplate = `This is an example of template for templar to use
{{ .FOO }} and {{ .extra }}.
{{ if .debug -}}
Debug is enabled
{{ end }}
...
const ExampleCustomTemplate = `# Generated by Templar at {{ now | date "2006-01-02 15:04:05" }}
